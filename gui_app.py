...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.title("星痕共鸣模组筛选器 V2.3 by：伊咪塔")
    ...
    def start_monitoring(self):
        ...
        self.category_menu.configure(state="normal") # 允许修改
        self.attributes_entry.configure(state="normal") # 允许修改
        self.preset_menu.configure(state="normal") # 允许修改
